 ...
 * since this could lead to privilege escalation if someone "translated"
 * one permission string into a higher privelege string. The string extractor 
 * takes care of extracting permission names defined in the perm hook for 
 * translation.
 *
